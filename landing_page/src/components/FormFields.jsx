...
//   const value = inputValue[field.name][field.name];
...
//     <>
//       <div className="mb-3">
//         <label htmlFor={`${field.name}Input`} className="form-label">{field.label}</label>
//         {field.type === 'textarea' ?
//         (
//         <textarea
...
//         )      
//         }
//         <ValidationMsg style={`inputFeedback ${feedbackStyle}`} message={hasError || 'Looks good!'}/>
//       </div>        
//     </>
//   )
// }
